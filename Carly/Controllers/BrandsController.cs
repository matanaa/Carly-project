...
namespace Carly.Controllers
{
    ...
    public class BrandsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,BrandName,OriginCountry")] Brand brand)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,BrandName,OriginCountry")] Brand brand)
        {
            if (ModelState.IsValid)
            {
